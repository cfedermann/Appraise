...
class HIT(models.Model):
    """
    HIT object model for WMT15 ranking evaluation.
...
class RankingTask(models.Model):
    """
    RankingTask object model for WMT15 ranking evaluation.
    """
...
def update_user_hit_mappings(sender, instance, created, **kwargs):
    ...
    if len(results) > 2:
        ...
        from appraise.wmt15.views import _compute_next_task_for_user
