...
from appraise.wmt15.models import HIT, RankingTask, RankingResult, \
...
LOGGER = logging.getLogger('appraise.wmt15.admin')
...
def export_hit_xml(modeladmin, request, queryset):
    ...
    """
    template = get_template('wmt15/result_export.xml')
